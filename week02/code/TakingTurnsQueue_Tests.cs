...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Enqueue method was using insert at index 0, this was causing an issue with the order of people in queue, resolved by replacing by Add.
    ...
    // Defect(s) Found: The person with infinite turns wasn't being considered in the code, because the code only enqueued people with turns > 1, ignoring people with turn <= 0, and never enqueueing them.
